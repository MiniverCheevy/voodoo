...
C:\Users\Shawn\.dnx\runtimes\dnx-clr-win-x86.1.0.0-beta4\bin\dnx.exe --appbase "c:\Dropbox\Lib\Projects\voodoo\Voodoo" "C:\Users\Shawn\.dnx\runtimes\dnx-clr-win-x86.1.0.0-beta4\bin\lib\Microsoft.Framework.PackageManager\Microsoft.Framework.PackageManager.dll" pack "c:\Dropbox\Lib\Projects\voodoo\Voodoo" --configuration Release --out "bin"
