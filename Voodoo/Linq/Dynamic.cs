...
//    /// <summary>
//    ///     Copyright (C) Microsoft Corporation.  All rights reserved. Microsoft Public License (Ms-PL)
...
//                try
//                {
//                    var tb = module.DefineType(typeName, TypeAttributes.Class | TypeAttributes.Public,
//                        typeof (DynamicClass));
...
//                    MethodAttributes.Public | MethodAttributes.SpecialName | MethodAttributes.HideBySig, dp.Type,
//                    Type.EmptyTypes);
...
//            typeof (String), typeof (SByte), typeof (Byte), typeof (Int16), typeof (UInt16), typeof (Int32),
...
//            }
//            if (exprType.IsAssignableFrom(type) || type.IsAssignableFrom(exprType) || exprType.GetTypeInfo().IsInterface ||
...
//            {
//                var members = t.FindMembers(MemberTypes.Property | MemberTypes.Field, flags, Type.FilterNameIgnoreCase,
//                    memberName);
...
//                    BindingFlags.Public | BindingFlags.DeclaredOnly | BindingFlags.Static, Type.FilterNameIgnoreCase,
//                    name);
...
//            for (var i = 0; i < args.Length; i++)
//            {
//                var c = CompareConversions(args[i].Type, m1.Parameters[i].ParameterType, m2.Parameters[i].ParameterType);
//                if (c < 0) return false;
//                if (c > 0) better = true;
//            }
//            return better;
...
//        {
//            return Expression.Call(null, typeof (string).GetMethod("Concat", new[] {typeof (object), typeof (object)}),
//                new[] {left, right});
//        }
