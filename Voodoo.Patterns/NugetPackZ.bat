...
C:\Users\Shawn\.dnx\runtimes\dnx-clr-win-x86.1.0.0-beta5\bin\dnx.exe --appbase "z:\Dropbox\Lib\Projects\voodoo\Voodoo" "C:\Users\Shawn\.dnx\runtimes\dnx-clr-win-x86.1.0.0-beta5\bin\lib\Microsoft.Framework.PackageManager\Microsoft.Framework.PackageManager.dll" pack "z:\Dropbox\Lib\Projects\voodoo\Voodoo" --configuration Release --out "bin"
