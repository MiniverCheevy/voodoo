...
namespace Voodoo
{
    ...
    {
        public static CollectionReconciler<TExisting, TModified, TKey> Reconcile<TExisting, TModified, TKey>(
            this ICollection<TExisting> existing, ICollection<TModified> modified,
        ...
        public static void AddIfNotExists<TKey, TValue>(this IDictionary<TKey, TValue> collection, TKey key,
            TValue value)
        {
